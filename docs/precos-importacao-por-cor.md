...
- O cliente ve o preco exato da cor que escolheu; nao e necessario usar so o maximo na vitrine, mas e util manter `preco_max_cor` para destaque "a partir de X" se quiser marketing honesto (usar o minimo) ou conservador (usar o maximo), conforme politica comercial.
...
## WooCommerce (estamparia.pt)

O site publico usa **WordPress + WooCommerce**. O mapeamento de campos na loja, variacoes por cor e o que o tema mostra por defeito ("desde X EUR") esta em:
